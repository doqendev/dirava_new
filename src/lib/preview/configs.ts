...
previewConfigs['one-piece-custom-led-lightbox-sign'] = {
  ...
  layers: [
    ...
    // Zoro purple / grey
    {
      svgColor: '#56037c',
      color: '#56037c',
      depth: 0.05, offsetZ: 12.25, metalness: 0.0, roughness: 0.5,
      emissive: '#56037c', emissiveIntensity: 0.9,
    },
    {
      svgColor: '#b7b7b7',
      color: '#b7b7b7',
      depth: 0.05, offsetZ: 12.35, metalness: 0.1, roughness: 0.4,
    ...
    // Chopper — light blue + pink
    {
      svgColor: '#60d0ec',
      color: '#60d0ec',
      depth: 0.05, offsetZ: 12.18, metalness: 0.0, roughness: 0.45,
      emissive: '#60d0ec', emissiveIntensity: 1.1,
    },
    {
      svgColor: '#fe98fd',
      color: '#fe98fd',
      depth: 0.05, offsetZ: 12.28, metalness: 0.0, roughness: 0.45,
    ...
    // Law — yellow swatch
    {
      svgColor: '#fddc00',
      color: '#fddc00',
      depth: 0.05, offsetZ: 12.17, metalness: 0.0, roughness: 0.4,
    ...
    // Nami — blue / pink / orange
    {
      svgColor: '#026bbe',
      color: '#026bbe',
      depth: 0.05, offsetZ: 12.22, metalness: 0.0, roughness: 0.5,
    ...
    },
    {
      svgColor: '#ffa91f',
      color: '#ffa91f',
      depth: 0.05, offsetZ: 12.24, metalness: 0.0, roughness: 0.4,
    ...
    // Shanks — brown / grey / dark red
    {
      svgColor: '#7a463c',
      color: '#7a463c',
      depth: 0.05, offsetZ: 12.23, metalness: 0.0, roughness: 0.6,
      emissive: '#7a463c', emissiveIntensity: 0.7,
    },
    {
      svgColor: '#868686',
      color: '#868686',
      depth: 0.05, offsetZ: 12.37, metalness: 0.1, roughness: 0.4,
      emissive: '#868686', emissiveIntensity: 0.7,
    },
    {
      svgColor: '#cd1414',
      color: '#cd1414',
      depth: 0.05, offsetZ: 12.32, metalness: 0.0, roughness: 0.5,
    ...
    },
    {
      svgColor: '#bababa',
      color: '#bababa',
      depth: 0.05, offsetZ: 12.36, metalness: 0.1, roughness: 0.4,
      emissive: '#bababa', emissiveIntensity: 1.6,
    },
    {
      svgColor: '#e60000',
      color: '#e60000',
      depth: 0.05, offsetZ: 12.31, metalness: 0.0, roughness: 0.5,
      emissive: '#e60000', emissiveIntensity: 0.9,
    },
    {
      svgColor: '#f38400',
      color: '#f38400',
      depth: 0.05, offsetZ: 12.19, metalness: 0.0, roughness: 0.4,
      emissive: '#f38400', emissiveIntensity: 1.1,
    },
    {
      svgColor: '#f3ea00',
      color: '#f3ea00',
      depth: 0.05, offsetZ: 12.16, metalness: 0.0, roughness: 0.4,
