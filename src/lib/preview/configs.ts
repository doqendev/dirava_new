...
previewConfigs['one-piece-custom-led-lightbox-sign'] = {
  ...
  variantFrontDecals: {
    Luffy: {
      ...
      // Push the decal back into a visibly-lit LED read while keeping the
      // floor matte. The glow is carried by the acrylic face, not the stage.
      lightIntensity: 1.2,
      emissive: '#ffffff',
  ...
  variantLightbox2DPreviews: {
    ...
    Zoro: {
      image: '/textures/preview/one-piece-lightbox-zoro-photo.png',
      imageWidth: 1254,
      imageHeight: 1254,
      textBox: { x: 407, y: 821, width: 456, height: 94 },
      fontFamily: '"OnePiecePreview", fantasy',
      textColor: '#ffffff',
      glowColor: 'rgba(255, 255, 255, 0.95)',
      maxFontRatio: 1.61,
    ...
    Ace: {
      image: '/textures/preview/one-piece-lightbox-ace-photo.png',
      imageWidth: 1254,
      imageHeight: 1254,
      textBox: { x: 410, y: 812, width: 456, height: 94 },
      fontFamily: '"OnePiecePreview", fantasy',
      textColor: '#ffffff',
      glowColor: 'rgba(255, 255, 255, 0.95)',
      maxFontRatio: 1.61,
    ...
    Chopper: {
      image: '/textures/preview/one-piece-lightbox-chopper-photo.png',
      imageWidth: 1254,
      imageHeight: 1254,
      textBox: { x: 418, y: 818, width: 456, height: 94 },
      fontFamily: '"OnePiecePreview", fantasy',
    ...
    Law: {
      image: '/textures/preview/one-piece-lightbox-law-photo.png',
      imageWidth: 1254,
      imageHeight: 1254,
      textBox: { x: 410, y: 811, width: 456, height: 94 },
      fontFamily: '"OnePiecePreview", fantasy',
      textColor: '#ffffff',
      glowColor: 'rgba(255, 255, 255, 0.95)',
      maxFontRatio: 1.61,
    ...
    Nami: {
      image: '/textures/preview/one-piece-lightbox-nami-photo.png',
      imageWidth: 1254,
      imageHeight: 1254,
      textBox: { x: 368, y: 816, width: 456, height: 94 },
      fontFamily: '"OnePiecePreview", fantasy',
      textColor: '#ffffff',
      glowColor: 'rgba(255, 255, 255, 0.95)',
      maxFontRatio: 1.61,
    ...
    Shanks: {
      image: '/textures/preview/one-piece-lightbox-shanks-photo.png',
      imageWidth: 1254,
      imageHeight: 1254,
      textBox: { x: 410, y: 812, width: 456, height: 94 },
      fontFamily: '"OnePiecePreview", fantasy',
  ...
  textLayers: [
    {
      ...
      roughness: 0.28,
      unlit: true,
      // Match the decal's neutral/cool LED diffuser while letting the
      // nameplate clearly read as lit acrylic.
      emissive: '#f2fbff',
