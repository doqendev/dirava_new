    ...
    <div className="min-h-screen bg-bg-primary pb-8">
      ...
      <div className="px-4 max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-white/60 mb-1">Apartment, suite, etc.</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm text-white/60 mb-1">Postal Code *</label>
              <input
                type="text"
                value={formData.zip}
          ...
          {/* Phone */}
          <div>
            <label className="block text-sm text-white/60 mb-1">Phone (for delivery)</label>
            <input
              type="tel"
